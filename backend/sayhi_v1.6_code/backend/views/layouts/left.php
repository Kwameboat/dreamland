        ...
        <?= backend\widgets\DreamlandMenu::widget([
            ...
            'items' => [
                ...
                [
                    ...
                    'icon' => 'star',
                    'url' => '#',
                    'visible' => Yii::$app->authPermission->canAny([
                        Yii::$app->authPermission::PAYMENT,
                        Yii::$app->authPermission::CREDIT_PACKAGE,
                        Yii::$app->authPermission::DREAMLAND_APPRAISAL,
                        Yii::$app->authPermission::DREAMLAND_MODERATION,
                        Yii::$app->authPermission::DREAMLAND_SAFETY,
                        Yii::$app->authPermission::DREAMLAND_SETTINGS,
                        Yii::$app->authPermission::BROADCAST_NOTIFICATIONS,
                    ]),
                    'items' => [
                        ...
                        ['label' => 'Dreamland Settings', 'icon' => 'cog', 'url' => ['/dreamland-settings'], 'visible' => Yii::$app->authPermission->can(Yii::$app->authPermission::DREAMLAND_SETTINGS)],
                        ...
                        ['label' => 'Payments Received', 'icon' => 'credit-card', 'url' => ['/payment'], 'visible' => Yii::$app->authPermission->can(Yii::$app->authPermission::PAYMENT)],
                        ['label' => 'Withdrawal Requests', 'icon' => 'bank', 'url' => ['/withdrawal-payment'], 'visible' => Yii::$app->authPermission->can(Yii::$app->authPermission::PAYMENT)],
                        ['label' => 'Completed Payouts', 'icon' => 'check-square-o', 'url' => ['/withdrawal-payment', 'type' => 'completed'], 'visible' => Yii::$app->authPermission->can(Yii::$app->authPermission::PAYMENT)],
                    ],
                ],
